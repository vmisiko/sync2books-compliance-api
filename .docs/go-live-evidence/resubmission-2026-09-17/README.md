...
|---|---|---|---|
| `invoice-copy.pdf` (= INV-260917-10) | KRACU0400001214/10 NS | 40,636.00 | goods + services, rates B and D, bank cheque, buyer PIN |
| `credit-note-copy.pdf` (= CN-260917-02) | KRACU0400001214/15 NC | −3,284.00 | partial credit of one goods and one service line against /10 |
| INV-260917-08 | /8 NS | 12,528.00 | single rate B |
| INV-260917-09 | /9 NS | 10,560.00 | rates B + A (exempt) + C (zero) on one invoice |
| INV-260917-11 | /11 NS | 1,740.00 | service only, M-Pesa, walk-in (no buyer PIN) |
| INV-260917-12 | /12 NS | 3,000.00 | zero-rated only, cash |
| INV-260917-13 | /13 NS | 3,600.00 | exempt only, card |
| INV-260917-14 | /14 NS | 29,580.00 | accommodation service |
